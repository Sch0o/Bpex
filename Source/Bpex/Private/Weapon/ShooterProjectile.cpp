...
void AShooterProjectile::NotifyHit(class UPrimitiveComponent* MyComp, AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	if (bExplodeOnHit)
	{
		...
		ProcessHit(Other, OtherComp,Hit);
...
void AShooterProjectile::ProcessHit(AActor* HitActor, UPrimitiveComponent* HitComp, const FHitResult& Hit)
{
	...
	if (HitComp->IsSimulatingPhysics())
	{
		...
		HitComp->AddImpulseAtLocation(-Hit.ImpactNormal * PhysicsForce, Hit.ImpactPoint);
	}
}
